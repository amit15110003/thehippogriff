...
<div style="padding-top: 25px;"><input type="text" class="form-control" placeholder="Email" ">
</div>
<div style="padding-top: 25px;"><input type="text" class="form-control" placeholder="Phone Number" ">
</div>
